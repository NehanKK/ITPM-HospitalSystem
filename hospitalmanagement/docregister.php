...
function getXmlHttpRequestObject() {
    ...
    var formData = new FormData();
     ...
     var req = getXmlHttpRequestObject(); // fuction to get xmlhttp object
                ...
                req.open("POST", 'doctor_det_submit.php', true); //open url using get method, get_GrnBill.php
                req.send(formData); 
            }
        }
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1><span>Doctors Register</span></h1>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Doctors Register</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /# column -->
    ...
    <div class="row"style="" >
      ...
      <div class="col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
        <label>Email</label>
        <input type="" name="mail" id="mail" class="form-control"  >
      </div>
        <div class="col-sm-4 col-md-4 col-lg-4">
    ...
    <div class="row"style="" >
        ...
        <input type="" name="did" id="did" class="form-control"  >
      </div>
        <div class="col-sm-4 col-md-4 col-lg-4">
