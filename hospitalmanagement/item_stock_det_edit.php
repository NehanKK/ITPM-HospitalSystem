...
$grn = mysqli_real_escape_string($con,$_GET['grn']);
...
//     }
    ...
    $itemdetsql ="SELECT * FROM grn_sum WHERE grnno='$grn'";
    $itemdetresult = mysqli_query($con,$itemdetsql);
    $itemdetrow = mysqli_fetch_assoc($itemdetresult);
    $grnno = $itemdetrow['grnno'];
    $grndate = $itemdetrow['grndate'];
...
for (var i = 1; i <= rowcountn; i++) {
    ...
    var dstock = document.getElementById(dnewstocknew).value;
            ...
            formData.append(dnewstocknew, dstock);
                ...
                var req = getXmlHttpRequestObject(); // fuction to get xmlhttp object
                    ...
                    if (req.readyState == 4) { //data is retrieved from server
                        if (req.status == 200) { // which reprents ok status 
                         ...
                         window.location.href = "itemstock_view.php";
                       
                    }            
                } 
            } 
                req.open("POST", 'newgrninsert_edit.php', true); //open url using get method, get_GrnBill.php
                req.send(formData); 
            }
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
    <div class="row">
      ...
      <div class="row"style="" >
        ...
        <div class="col-sm-3 col-md-3 col-lg-3">
          <label>Date</label>
        <input type="text" name="grnDate" id="grnDate" class="form-control" value="<?php echo $grndate?>" readonly>
      ...
      <div class="col-sm-3 col-md-3 col-lg-3">
        <label>GRN No</label>
        <input type="text" name="grnno" id="grnno" class="form-control" value="<?php echo $grnno ?>" readonly>
      </div>
               ...
               <h3 align="center" style="margin-top: 3%;"><font style="background-color:yelllow;">Item Details</font></h3>
                                        <div class="row"style="margin-top: 3%;">
                                            ...
                                            <?Php
                                                        ...
                                                        $sqlitemname="SELECT * FROM grn_det WHERE grn_No='$grnno'";
                                            ...
                                            $total_price = $rowitemname['total_price'];
                                            $stock = $rowitemname['stock'];
                                            $unit_Price = $rowitemname['unit_Price'];
 ...
 <div class="row" style="padding:5px;">
                                                ...
                                                <div class="col-xs-4 col-sm-2 col-md-2 col-lg-2"style="padding:5px;">
                                                 ...
                                                 <div class="col-xs-4 col-sm-2 col-md-2 col-lg-2"style="padding:5px;">
                                                    ...
                                                    <input type="number" name="newstock<?php echo $i ?>"class="form-control" id="newstock<?php echo $i ?>" onkeyup="itemamountcal(id);"   value="<?php echo $stock ?>"style="text-align: center;">
                                                    <input type="hidden" name="dnewstock<?php echo $i ?>" id="dnewstock<?php echo $i ?>" value="<?php echo $stock ?> ">
                                                </div>
                                                <div class="col-xs-4 col-sm-2 col-md-2 col-lg-2"style="padding:5px;">
                                                    <label id="validlabel"><strong>Unit Price</strong></label>
                                                    <input type="text" name="unitPrice<?php echo $i ?>" class="form-control" id="unitPrice<?php echo $i ?>" readonly="readonly" value="<?php echo $unit_Price?>" style="text-align: right;">
                                                </div>
                                                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3"style="padding:5px;">
                                                    <label id="validlabel"><strong>Amount (Rs)</strong></label>
                                                    <input type="text" name="getamount<?php echo $i ?>" class="form-control" id="getamount<?php echo $i ?>" style="text-align: right;" value="<?php echo $total_price?>">
                                                </div>
    </div>
                                                <?php
                                        $i++;   }   
...
<input type="hidden" name="dcheck" id="dcheck" value="<?php echo $checkdate ?>">
    <input type="submit" name="edit" id="edit" value="EDIT" class="btn btn-danger" onclick="submitnewgrn()" />
</div>                         
<!-- methanata enakam  -->
</div>
