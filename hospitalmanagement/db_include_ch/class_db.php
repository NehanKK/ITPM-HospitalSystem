...
class mySqlDB
{
        ...
        function connect($hostName="localhost",$userName="root",$passWord="",$dBase="tkbatterydb")
        {			
         //@mysql_connect($hostName,$userName,$passWord) or die("Couldn't connect to mySQL server");
		 $cone = @mysqli_connect($hostName,$userName,$passWord,$dBase) or die("Couldn't connect to mySQL server");
        }

        //Select the Database
        //param1:Database name:defualt-test
        function dBSelect($hostName="localhost",$userName="root",$passWord="",$dBase="tkbatterydb")
        {
         //$this->dBaseKey=mysql_select_db($dBase) or die("Couldn't select database");
		 //$this->dBaseKey=mysqli_connect($hostName,$userName,$passWord,$dBase) or die("Couldn't connect to mySQL server");
        }
        ...
        {
			$cone = @mysqli_connect('localhost','root','','tkbatterydb');
